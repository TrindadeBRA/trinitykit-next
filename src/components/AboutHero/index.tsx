        ...
        <div className="relative isolate -z-10 overflow-hidden bg-linear-to-b from-indigo-100/20 pt-14">
            ...
            <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                    <div>
                        <h1 className="max-w-2xl text-5xl font-semibold tracking-tight text-balance text-black sm:text-7xl lg:col-span-2 xl:col-auto">
                            We are Tiken!
                        </h1>
                        <h2 className="max-w-2xl text-2xl font-bold tracking-tight text-balance text-black sm:text-4xl lg:col-span-2 xl:col-auto mt-2">
